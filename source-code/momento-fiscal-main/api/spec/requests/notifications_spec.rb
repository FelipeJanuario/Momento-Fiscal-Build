...
RSpec.describe "/api/v1/notifications" do
  ...
  let(:valid_attributes) do
    attributes_for(:notification, user_id: current_user.id)
  end
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_notification_url(notification), as: :json, headers: valid_headers
      expect(response).to be_successful
    end
  end
  ...
  #       expect {
  #         post api_v1_notifications_url,
  #              params: { notification: invalid_attributes }, as: :json, headers: valid_headers
