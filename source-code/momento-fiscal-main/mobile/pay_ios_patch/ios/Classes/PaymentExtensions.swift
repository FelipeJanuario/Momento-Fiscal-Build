...
extension PKPaymentNetwork {
  ...
  public static func fromString(_ paymentNetworkString: String) -> PKPaymentNetwork? {
    ...
    case "amex":
      return .amex
    // bankAxept removido — requer iOS 17.5 SDK (indisponível no Xcode 14.2)
    case "bancontact":
    ...
    case "masterCard":
      return .masterCard
    // meeza removido — requer iOS 17.4 SDK (indisponível no Xcode 14.2)
    case "mir":
    ...
    case "nanaco":
      ...
      return .nanaco
    // NAPAS removido — requer iOS 17.5 SDK (indisponível no Xcode 14.2)
    // pagoBancomat removido — requer iOS 17.0 SDK (indisponível no Xcode 14.2)
    // postFinance removido — requer iOS 16.4 SDK (indisponível no Xcode 14.2)
    case "privateLabel":
      return .privateLabel
    case "quicPay":
      return .quicPay
    case "suica":
      return .suica
    // tmoney removido — requer iOS 17.0 SDK (indisponível no Xcode 14.2)
    case "visa":
      return .visa
    case "vPay":
      guard #available(iOS 12.0, *) else { return nil }
